...
namespace GenericService.DAL.Services
{
    public class BsonDocumentRepository : GenericMongoRepository<BsonDocument, string, JObject>
    {
            ...
            if (!collection.Find(new BsonDocument()).Any())
                collection.InsertMany(
                    new List<BsonDocument> {
                        ...
                        BsonDocument.Parse("{\"_id\":{\"$oid\":\"5e67f1ed2e106e15ccafbbd1\"},\"number\":\"68047372\",\"model\":\"12-9869\",\"countryOwner\":\"РОССИЯ\",\"vagonType\":{\"$numberInt\":\"4\"},\"rentalEndDate\":\"2024-05-19T21:00:00Z\",\"isClosedFloor\":true,\"capacity\":{\"$numberInt\":\"77\"},\"tare\":{\"$numberDouble\":\"22.5\"},\"ownType\":{\"$numberInt\":\"1\"},\"axlesCount\":{\"$numberInt\":\"4\"},\"volume\":{\"$numberInt\":\"92\"},\"length\":{\"$numberDouble\":\"13.92\"},\"ownerName\":\"Акционерное общество \\\"Вагон Лизинг\\\"\",\"tenantName\":\"Акционерное общество \\\"ФЫВАП\\\"\",\"operatorName\":null,\"mileage\":{\"$numberInt\":\"742044\"},\"productionYear\":{\"$numberInt\":\"2014\"},\"lastRepairDate\":\"2020-02-19T21:00:00Z\",\"nextRepairDate\":\"2022-12-23T21:00:00Z\",\"imgUrl\":\"https://vgudok.com/sites/default/files/field/image/poluvagon_uvz.jpg\",\"createdAt\":\"2020-03-10T20:00:45.218Z\",\"updatedAt\":\"2020-03-22T20:56:43.268Z\"}"),
                        ...
                        BsonDocument.Parse("{\"_id\":{\"$oid\":\"5e6e8b665009cb1a384ac46d\"},\"number\":\"68250927\",\"model\":\"12-4106\",\"countryOwner\":\"РОССИЯ\",\"vagonType\":{\"$numberInt\":\"3\"},\"rentalEndDate\":\"2023-01-30T21:00:00Z\",\"isClosedFloor\":null,\"capacity\":{\"$numberInt\":\"70\"},\"tare\":{\"$numberDouble\":\"23.6\"},\"ownType\":{\"$numberInt\":\"1\"},\"axlesCount\":{\"$numberInt\":\"4\"},\"volume\":{\"$numberInt\":\"78\"},\"length\":{\"$numberDouble\":\"13.92\"},\"ownerName\":\"ООО \\\"КОНТОРА\\\"\",\"tenantName\":\"Акционерное общество \\\"ФЫВАП\\\"\",\"operatorName\":null,\"mileage\":{\"$numberInt\":\"61923\"},\"productionYear\":{\"$numberInt\":\"2010\"},\"lastRepairDate\":\"2019-11-13T21:00:00Z\",\"nextRepairDate\":\"2022-03-28T21:00:00Z\",\"imgUrl\":\"http://dvmash.biz/images/stories/poluvagoni/12-4106_ft.jpg\",\"createdAt\":\"2020-03-15T20:09:10.647Z\",\"updatedAt\":\"2020-03-22T20:59:07.388Z\"}")
                    }
                );
        }
        ...
        public override JObject Create(JObject item)
        {
            ...
            if (!document.TryGetValue("_id", out BsonValue bsonValue))
                document.InsertAt(0, new BsonElement("_id", ObjectId.GenerateNewId()));
            else
            {
            //if (document.FirstOrDefault(a => a.Name == "_id") is BsonElement idElement)
                bsonValue = BsonValue.Create(ObjectId.GenerateNewId());
